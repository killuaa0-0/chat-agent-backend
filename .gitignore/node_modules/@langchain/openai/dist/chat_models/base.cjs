...
var BaseChatOpenAI = class extends _langchain_core_language_models_chat_models.BaseChatModel {
	...
	*/
	...
	constructor(fields) {
		...
		const serializedBaseUrl = fields && "baseUrl" in fields && typeof fields.baseUrl === "string" ? fields.baseUrl : void 0;
		const gatewayConfig = (0, _langchain_core_utils_gateway.resolveLangSmithGatewayConfig)({
			baseURL: fields?.configuration?.baseURL ?? serializedBaseUrl ?? ((0, _langchain_core_utils_env.getEnvironmentVariable)("OPENAI_API_BASE") || (0, _langchain_core_utils_env.getEnvironmentVariable)("OPENAI_BASE_URL") || void 0),
		...
		this._addVersion("@langchain/openai", "1.5.13");
	}
	/**
